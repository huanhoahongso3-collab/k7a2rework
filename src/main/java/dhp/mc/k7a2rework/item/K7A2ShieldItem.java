...
public class K7A2ShieldItem extends ShieldItem {
	public K7A2ShieldItem() {
		super(new Item.Properties().durability(4756).fireResistant());
		ItemGroupEvents.modifyEntriesEvent(K7a2reworkModTabs.TAB_K_7_A_2).register(content -> content.accept(this));
	}

	@Override
	public boolean isValidRepairItem(ItemStack itemstack, ItemStack repairitem) {
		return Ingredient.of(new ItemStack(K7a2reworkModItems.K_7_A_2_INGOT)).test(repairitem);
	}
